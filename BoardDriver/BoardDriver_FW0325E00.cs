...
namespace BoardDriver
{
    ...
    public class BoardDriver_FW0325E00 : IBoardDriver
    {
      ...
      public  enum FunctionCode
       ...
       public Dictionary<FunctionCode, byte> FunctionCodeDic = new Dictionary<FunctionCode, byte>()
        {
       ...
       public Dictionary<DataType, byte> DataTypeDic = new Dictionary<DataType, byte>()
        {
            { DataType.Null, 0x00},
            { DataType.Bool, 0x01},
            { DataType.U8, 0x02},
       ...
       public Dictionary<CommandID, byte[]> CommandIDDic = new Dictionary<CommandID, byte[]>()
        {
        ...
        protected virtual byte[] WaitCommandEnd(byte[] Send, int Sleep)
        {
            try
            {
                Send = WrapCmd(Send);
